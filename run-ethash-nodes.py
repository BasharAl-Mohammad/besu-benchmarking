...
def find_enode_url(base_data_path, genesis_file):
    ...
    besu_command = f"besu/bin/besu --data-path=Ethash-Network/Node-1/data --genesis-file=Ethash-Network/genesis.json --miner-enabled --miner-coinbase fe3b557e8fb62b89f4916b721be55ceb828dbd73 --config-file=config/config.toml"
...
if __name__ == "__main__":
    ...
    if node_1_enode_url:
        ...
        command_template = (
            "besu/bin/besu --data-path={data_path} --genesis-file={genesis_file} "
            f"--bootnodes={node_1_enode_url} --p2p-port={p2p_port}"
        )
